...
class EA:
    ...
    def population_init(self):
        ...
        for i in range(self.population_size):
            # newChromosome = createNewChromosome()
            # getFitness()
    ...
    def Generation(self):
        ...
        parents = self.selection_scheme.get_parents(
            self.population, fitness_values, self.selection_method)
        offspring = list()
        ...
        self.population = self.selection_scheme.get_survivor(
            self.population, fitness_values, self.population_size, self.selection_method)
