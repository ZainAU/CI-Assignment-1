...
class EA:
    def __init__(self, seed=rng, population_size=30, dataset="qa194.tsp",
        ...
        self.selection_scheme = Selection(
            offspring_number=self.offspring_number, seed=seed)
    ...
    def mutation(self, chromosome):
        # selecting random indexes to insert or swap
    ...
    # ideally should've been implemented in TSP.py - Zain who was implementing crossover for mona-lisa and whll now have to re-implement the Gereration function
    ...
    def Generation(self):
        ...
        if self.optimization_type == 'minimization':
            ...
            AssertionError("Please input correct type of optimization")
        self.population = self.selection_scheme.get_survivor(
            self.population, fitness_values, self.population_size, self.survival_Selection_method)
